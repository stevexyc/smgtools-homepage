...
<section class="col-lg-4 col-sm-4 eventscol">
	<h2>Events</h2>
	<?php
		$events = @file_get_contents("https://smgapps.bu.edu/smgnet/smgcalendarU/todayjson_smgworld.cfm");
		if($events != false) {
	...
	?>
	<a href="http://smgworld.bu.edu/calendar/" target="_blank">All SMG Events >></a>
	<hr>
