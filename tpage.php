...
<section class="col-lg-4 col-sm-4 eventscol">
	<h2>Events</h2>
	<?php
		$events = @file_get_contents("http://smgapps.bu.edu/smgnet/smgcalendarU/todayjson_smgworld.cfm");
		if($events != false) {
...
<section class="col-lg-8 col-sm-8">
    ...
    <div id="slider" class="nivoSlider">
    	<?php
$pageID = isset($_GET["page"]) ? $_GET["page"] : "main_page";
...
<section class="col-lg-6 news-col">
	...
	?>
	<article>
		<a href="<?=h($item->link)?>" class="clearfix">
...
<section class="col-lg-6 hourscol">
	...
	<h2>Hours</h2>
	<?php
	$hourdata = @file_get_contents("http://smgwiki.bu.edu/hours2/data.php");
	if($hourdata != false) {
